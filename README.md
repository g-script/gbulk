...
ARGUMENTS
  ...
  DESTINATION  [default: /home/nicolas/dev/gbulk/gbulk-backup-1581268034705] backup destination path
...
_See code: [src/commands/backup.js](https://github.com/g-script/gbulk/blob/v0.0.0/src/commands/backup.js)_
...
_See code: [src/commands/login.js](https://github.com/g-script/gbulk/blob/v0.0.0/src/commands/login.js)_
...
_See code: [src/commands/logout.js](https://github.com/g-script/gbulk/blob/v0.0.0/src/commands/logout.js)_
<!-- commandsstop -->
